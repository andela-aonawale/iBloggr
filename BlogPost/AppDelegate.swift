...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        UINavigationBar.appearance().barTintColor = UIColor(red: 59/255.0, green: 89/255.0, blue:
            152/255.0, alpha: 0.3)
        ...
        UITabBar.appearance().tintColor = UIColor(red: 59/255.0, green: 89/255.0, blue:152/255.0, alpha: 1.0)
